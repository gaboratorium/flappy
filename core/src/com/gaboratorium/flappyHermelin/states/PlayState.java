...
public class PlayState extends State
{
    ...
    protected PlayState(GameStateManager gsm)
    {
        ...
        groundPos2 = new Vector2((cam.position.x - cam.viewportWidth / 2) + ground.getWidth(), FlappyHermelin.GROUND_Y_OFFSET);
    ...
    public void update(float dt)
    {
        ...
        if (!isPlayerDead)
        {
            ...
            if (bird.getPosition().y <= ground.getHeight() + FlappyHermelin.GROUND_Y_OFFSET)
            {
                handleDeath();
            }
        }
    ...
    public void renderGameplay(SpriteBatch sb)
    {
        ...
        sb.draw(bg, cam.position.x - (cam.viewportWidth / 2), - FlappyHermelin.GROUND_Y_OFFSET / 2);
